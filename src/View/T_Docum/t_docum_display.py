...
class t_docum_display(t_display):
    ...
    def __init__(self, app, bg="#135547"):
        ...
        # 2. DOCU_NOM_E
        lbl = tk.Label(self.frame, text="Nombre Español:", font=("Arial Black",8,"bold"), bg=bg)
        ...
        # 3. DOCU_NOM_I
        lbl = tk.Label(self.frame, text="Nombre Inglés:", font=("Arial Black",8,"bold"), bg=bg)
        ent = tk.Entry(self.frame, width=60, validate="key", validatecommand=(vmax,'%P'), bd=0, bg="white")
        self.elements.append([lbl, ent]); self.elements_types.append("str")

        # 4. DOCU_NOM_F
        lbl = tk.Label(self.frame, text="Nombre Francés:", font=("Arial Black",8,"bold"), bg=bg)
        ent = tk.Entry(self.frame, width=60, validate="key", validatecommand=(vmax,'%P'), bd=0, bg="white")
        self.elements.append([lbl, ent]); self.elements_types.append("str")

        # 5. DOCU_NOM_A
        lbl = tk.Label(self.frame, text="Nombre Alemán:", font=("Arial Black",8,"bold"), bg=bg)
        ent = tk.Entry(self.frame, width=60, validate="key", validatecommand=(vmax,'%P'), bd=0, bg="white")
        self.elements.append([lbl, ent]); self.elements_types.append("str")
