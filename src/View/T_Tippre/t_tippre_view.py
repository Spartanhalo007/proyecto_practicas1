...
from Service.tippre_service import TippreService

from View.T_Tippre.t_tippre_display import t_tippre_display
...
class t_tippre_view(t_view):
    ...
    def __init__(self, root):
        ...
        self.service = TippreService(conexion)

        super().__init__()

        def guardar(vals):
            payload = {
                "tippre_cod": int(vals[0]),
                "tippre_nom": vals[1]
            }
        ...
        crud_display(
            ...
            table_atributes_func = lambda: ["tippre_cod", "tippre_nom"],
            pk_func              = lambda: "tippre_cod",
