...
from Service.equica_service import EquicaService

from View.T_Equica.t_equica_display import t_equica_display
from ..Components.crud_display import crud_display
from ..t_view import t_view

class t_equica_view(t_view):

    def __init__(self, root):
        self.title = "Tabla EQUICA"
        self.app = tk.Toplevel(root)
        self.app.title("t_equica")
        self.data_display_frame = t_equica_display

        conexion = obtener_conexion()
        self.service = EquicaService(conexion)
        ...
        crud_display(
            ...
            table_atributes_func = lambda: ["equi_banco","equi_catas","equi_conce"],
            pk_func              = lambda: "equi_banco",
