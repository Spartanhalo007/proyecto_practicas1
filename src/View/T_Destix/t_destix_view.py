...
from Service.destix_service import DestixService

from View.T_Destix.t_destix_display import t_destix_display
from ..Components.crud_display import crud_display
from ..t_view import t_view

class t_destix_view(t_view):

    def __init__(self, root):
        self.title = "Tabla de Destinos de la Inversión - XML"
        self.app = tk.Toplevel(root)
        self.app.title("t_destix")

        self.w = 430
        self.h = 170

        self.data_display_frame = t_destix_display

        conexion = obtener_conexion()
        self.service = DestixService(conexion)
        ...
        crud_display(
            ...
            table_atributes_func = lambda: ["inv_codigo","inv_nombre"],
