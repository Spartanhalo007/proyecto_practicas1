...
from Service.segmen_service import SegmenService

from View.T_Segmen.t_segmen_display import t_segmen_display
...
class t_segmen_view(t_view):
    ...
    def __init__(self, root):
        ...
        self.service = SegmenService(conexion)

        super().__init__()

        def guardar(vals):
            payload = {
                "segmen_cod": int(vals[0]),
                "segmen_nom": vals[1]
            }
        ...
        crud_display(
            ...
            table_atributes_func = lambda: ["segmen_cod","segmen_nom"],
            pk_func              = lambda: "segmen_cod",
