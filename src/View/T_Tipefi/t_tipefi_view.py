...
from Service.tipefi_service import TipefiService

from View.T_Tipefi.t_tipefi_display import t_tipefi_display
...
class t_tipefi_view(t_view):
    ...
    def __init__(self, root):
        ...
        self.service = TipefiService(conexion)

        super().__init__()

        def guardar(vals):
            payload = {
                "tef_codigo": int(vals[0]),
                "tef_descri": vals[1]
            }
        ...
        crud_display(
            ...
            table_atributes_func = lambda: ["tef_codigo", "tef_descri"],
            pk_func              = lambda: "tef_codigo",
