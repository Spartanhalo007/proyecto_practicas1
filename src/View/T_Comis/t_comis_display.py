...
class t_comis_display(t_display):
    """Display de campos para la tabla t_comis."""
    ...
    def __init__(self, app, bg="#135547"):
        ...
        # 3. COM_PORCE
        lbl = tk.Label(self.frame, text="Porcentaje:", font=("Arial Black",8,"bold"), bg=bg)
        ent = tk.Entry(self.frame, width=12, bd=0, bg="white")
        self.elements.append([lbl, ent]); self.elements_types.append("dec")

        # 4. COM_MINIMA
        lbl = tk.Label(self.frame, text="Mínima en USD:", font=("Arial Black",8,"bold"), bg=bg)
        ent = tk.Entry(self.frame, width=16, bd=0, bg="white")
        self.elements.append([lbl, ent]); self.elements_types.append("dec")

        # 5. COM_FIJA
        lbl = tk.Label(self.frame, text="Costo Fijo en USD:", font=("Arial Black",8,"bold"), bg=bg)
        ent = tk.Entry(self.frame, width=16, bd=0, bg="white")
        self.elements.append([lbl, ent]); self.elements_types.append("dec")

        # 6. COM_MENSA
        lbl = tk.Label(self.frame, text="VI mens o Chq USD:", font=("Arial Black",8,"bold"), bg=bg)
        ent = tk.Entry(self.frame, width=16, bd=0, bg="white")
        self.elements.append([lbl, ent]); self.elements_types.append("dec")

        # 7. COM_GTOS
        lbl = tk.Label(self.frame, text="Gtos en Pesos:", font=("Arial Black",8,"bold"), bg=bg)
        ent = tk.Entry(self.frame, width=16, bd=0, bg="white")
        self.elements.append([lbl, ent]); self.elements_types.append("dec")

        # 8. COM_PORIVA
        lbl = tk.Label(self.frame, text="Porcent IVA:", font=("Arial Black",8,"bold"), bg=bg)
        ent = tk.Entry(self.frame, width=12, bd=0, bg="white")
        self.elements.append([lbl, ent]); self.elements_types.append("dec")
