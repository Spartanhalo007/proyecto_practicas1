...
from Service.comis_service import ComisService

from View.T_Comis.t_comis_display import t_comis_display
from ..Components.crud_display import crud_display
from ..t_view import t_view

class t_comis_view(t_view):

    def __init__(self, root):
        self.title = "Tabla de Comisiones"
        self.app = tk.Toplevel(root)
        self.app.title("t_comis")
        self.app.configure(bg="#135547")
        self.data_display_frame = lambda parent: t_comis_display(parent, bg="#135547")

        self.h = 325
        self.w = 500

        conexion = obtener_conexion()
        self.service = ComisService(conexion)
