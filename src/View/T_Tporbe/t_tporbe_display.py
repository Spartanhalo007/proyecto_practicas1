...
class t_tporbe_display(t_display):
    """Display de campos para la tabla t_tporbe."""
    ...
    def __init__(self, app):
        ...
        # 2. TP_NOMBRE (50 chars)
        lbl = tk.Label(self.frame, text="Nombre:", font=("Arial",8,"bold"), bg="#c0c0c0")
        ent = tk.Entry(self.frame, width=40, validate="key", validatecommand=(v50, '%P'),
                       bd=0, bg="white")
