...
from Service.transa_service import TransaService

from View.T_Transa.t_transa_display import t_transa_display
...
class t_transa_view(t_view):
    ...
    def __init__(self, root):
        ...
        def guardar(vals):
            payload = {
                "tran_codig": int(vals[0]),
                "tran_nombr": vals[1],
                "tran_sec1":  int(vals[2])
            }
        ...
        crud_display(
            ...
            table_atributes_func = lambda: ["tran_codig","tran_nombr","tran_sec1"],
            pk_func              = lambda: "tran_codig",
