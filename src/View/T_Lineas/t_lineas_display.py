...
class t_lineas_display(t_display):
    ...
    def __init__(self, app):
        ...
        # 2. LINEA_COSU
        lbl = tk.Label(self.frame, text="Consumo:", font=("Arial",8,"bold"), bg="#c0c0c0")
        ...
        ent = tk.Entry(self.frame, width=120, validate="key", validatecommand=(v120, '%P'), bd=0, bg="white")
        self.elements.append([lbl, ent]); self.elements_types.append("str")

        # 4. LINEA_GMF
        lbl = tk.Label(self.frame, text="GMF (0/1):", font=("Arial",8,"bold"), bg="#c0c0c0")
